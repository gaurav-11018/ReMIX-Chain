...
export default function Marketplace() {
  //THIS IS SAMPLE PLACEHOLDER! JUST TO FILL THE MARKETPLACE AS UPLOADING THEM WOULD TAKE MORE TIME , HOWEVER ITS TRIED AND TESTED. YOU CAN UPLOAD ALL THE CONTESTS WITHOUT ANY ERRORS!!!!!!!!!
  const sampleData = [
    {
      name: "DANCE-MONEY",
